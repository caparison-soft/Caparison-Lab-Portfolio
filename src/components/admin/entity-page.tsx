...
export async function EntityPage({ entity, marker, heading, intro, singular, plural, fields, blank, featuredToggle, noStatus, aside }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3 max-w-[900px]">
      ...
      <SimpleCrud entity={entity} rows={rows} fields={fields} singular={singular} plural={plural} emptyState={`No ${plural} yet. Add your first one.`} blank={blank} featuredToggle={featuredToggle} noStatus={noStatus} aside={aside} />
    </div>
  );
}
