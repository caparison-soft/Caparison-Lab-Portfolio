...
- Clear glass on the dark hero: thickness 0.15, ior 1.6, dispersion 6, roughness 0.02, clearcoat 1, transmission 1, envMapIntensity 3.6, envPreset "wide" (broad softboxes on a pure black base so faces disappear on black; the original thin-strip rig stays the module default), depthScale 0.65, offset x 0.55 over the line ends, backdrop takes the section background, text plane at z -0.8, fit 1.9, offset x 1.2 (over the line ends), depthScale 0.6, swing ±0.55 rad instead of a full spin
