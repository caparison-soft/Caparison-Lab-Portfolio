...
const blocks: Block[] = [
  ...
  { key: "case.carouselPrev", group: "Case study", label: "Carousel: previous button label", value: "Previous slide", helpText: "Read by screen readers." },
  { key: "case.carouselNext", group: "Case study", label: "Carousel: next button label", value: "Next slide", helpText: "Read by screen readers." },
